    ...
    class RegisterViewController: UIViewController,UITextFieldDelegate {
        ...
        func getIntialDropDown(type : type) {
            ...
            manger.perform(methodType: .get, needToken: false, serviceName: servicename, parameters: nil, needQuerParemeter: false, queryString: ""){
                (JSON, String) -> Void in
        ...
        @IBAction func regBtnTapped(_ sender: Any) {
            ...
            manger.perform(methodType: .post, needToken: false, serviceName: .register, parameters: params, needQuerParemeter: false, queryString: ""){
                (JSON, String) -> Void in
                if String != nil {
